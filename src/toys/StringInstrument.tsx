...
function StringInstrument(props: Props) {
    ...
    }, [NoteLabling.ActiveNoteNames, NoteLabling.NoteNames, activeNotes, checkEmphasis, circleElemRadius, colorPalette.Widget_Primary, fretElemYOffset, fretSpacing, getXPos, getYPos, homeNote, noteLabeling, props.fretCount, props.tuning, props.width, setHomeNote, settings?.isPeaceModeEnabled, stringSpacing, updateNotes]);
